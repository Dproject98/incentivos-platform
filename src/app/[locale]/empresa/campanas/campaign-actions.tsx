...
export function CampaignActions({ campaignId, status }: Props) {
  ...
  return (
    <button
      ...
      style={{
        background: status === "ACTIVE" ? "rgba(217,179,108,0.10)" : "rgba(232,115,90,0.10)",
        color: status === "ACTIVE" ? "#D9B36C" : "#E8735A",
        border: `1px solid ${status === "ACTIVE" ? "rgba(217,179,108,0.25)" : "rgba(232,115,90,0.20)"}`,
      }}
    >
      {status === "ACTIVE" ? (
