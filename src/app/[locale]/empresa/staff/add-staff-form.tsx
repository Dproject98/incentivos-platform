...
export function AddStaffForm() {
  ...
  return (
    <div className="rounded-2xl p-5 space-y-4" style={{ background: "#1E2023", border: "1px solid #34373C" }}>
      <p className="text-[10px] uppercase tracking-[0.12em] font-mono flex items-center gap-2" style={{ color: "#93979E", fontFamily: "var(--font-mono)" }}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-[13px] font-medium mb-1.5" style={{ color: "#F2F1EF" }}>{t("name")}</label>
            <input
              required
              value={form.name}
          ...
          <div>
            <label className="block text-[13px] font-medium mb-1.5" style={{ color: "#F2F1EF" }}>{t("email")}</label>
            <input
              type="email"
              required
              value={form.email}
      ...
      {newPin && (
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] mt-1.5" style={{ color: "#93979E" }}>
