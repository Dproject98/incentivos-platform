  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      >
        ...
        <div>
          <p className="text-[14px] font-medium" style={{ color: "#F2F1EF" }}>Cómo funciona</p>
          <p className="text-[13px] mt-1" style={{ color: "#AEB2B8" }}>{t("desc")}</p>
          <p className="text-[12px] mt-1.5" style={{ color: "#93979E" }}>
