...
export default function RegisterEmpresaPage() {
  ...
  const handleFocus = (e: React.FocusEvent<HTMLInputElement>) => (e.currentTarget.style.borderColor = "#E8735A")
  const handleBlur  = (e: React.FocusEvent<HTMLInputElement>) => (e.currentTarget.style.borderColor = "#34373C")
    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: "#16171A" }}>
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="rounded-2xl p-8" style={{ background: "#1E2023", border: "1px solid #34373C" }}>
          ...
          <p className="text-[14px] mb-7" style={{ color: "#93979E" }}>{t("empresa_desc")}</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p
              ...
              style={{ color: "#93979E", fontFamily: "var(--font-mono)", borderColor: "#34373C" }}
            >
              Datos del negocio
            </p>

            <div>
              <label className="block text-[13px] font-medium mb-1.5" style={{ color: "#F2F1EF" }}>{t("business_name")}</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-[13px] font-medium mb-1.5" style={{ color: "#F2F1EF" }}>{t("business_type")}</label>
              <Select value={form.businessType} onValueChange={(v) => setForm({ ...form, businessType: v })}>
                ...
                <SelectContent
                  ...
                  style={{ background: "#26282C", borderColor: "#34373C", color: "#F2F1EF" }}
                >
            ...
            <div>
              <label className="block text-[13px] font-medium mb-1.5" style={{ color: "#F2F1EF" }}>{t("business_address")}</label>
              <input
                type="text"
          ...
          <p className="mt-6 text-center text-[13px]" style={{ color: "#93979E" }}>
            {t("have_account")}{" "}
            <Link href={`/${locale}/login`} className="font-medium" style={{ color: "#E8735A" }}>
              {t("login")}
            </Link>
          </p>
        </div>
