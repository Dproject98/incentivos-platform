    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: "#16171A" }}>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          {perks.map((p) => (
            <div
              ...
              style={{ background: "oklch(0.70 0.15 35 / 0.07)", border: "1px solid oklch(0.70 0.15 35 / 0.15)" }}
            >
              <span className="block text-[16px] mb-1" style={{ color: "#E8735A" }}>{p.symbol}</span>
              <span className="text-[11px] font-medium" style={{ color: "#E8735A" }}>{p.label}</span>
            </div>
          ))}
        </div>
        ...
        <div className="rounded-2xl p-8" style={{ background: "#1E2023", border: "1px solid #34373C" }}>
          ...
          <p className="text-[14px] mb-7" style={{ color: "#93979E" }}>{t("captador_desc")}</p>
