  ...
  return (
    <div className="space-y-8 max-w-6xl">
      <div>
        ...
        <p className="text-[14px] mt-1" style={{ color: "#93979E" }}>{campaigns.length} campañas activas disponibles</p>
      </div>
          ...
          {campaigns.map((campaign) => {
            ...
            return (
              ...
              >
                <div className="p-5 flex-1">
                  <div className="flex items-start justify-between gap-2 mb-3">
                    <div className="min-w-0">
                      ...
                      <p className="text-[13px] mt-0.5" style={{ color: "#93979E" }}>{campaign.business.name}</p>
                    </div>
                    <span
                  ...
                  {campaign.description && (
                    <p className="text-[13px] mb-4 line-clamp-2" style={{ color: "#93979E" }}>{campaign.description}</p>
                  )}
                  ...
                  <div className="mt-4 space-y-1.5">
                    {campaign.business.address && (
                      <div className="flex items-center gap-1.5 text-[12px]" style={{ color: "#93979E" }}>
                        <MapPin className="h-3.5 w-3.5 shrink-0" />
                        {campaign.business.address}
                      </div>
                    )}
                    <div className="text-[12px]" style={{ color: "#93979E" }}>
                      {campaign.endDate
                ...
                <div className="p-4" style={{ borderTop: "1px solid #34373C" }}>
                  <Link
